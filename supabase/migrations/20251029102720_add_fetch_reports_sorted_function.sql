-- Migration: Add RPC function for fetching reports with date-grouped sorting
-- This function groups reports by observation date, then sorts by creation time within each day
