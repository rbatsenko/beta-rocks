...
export function SearchDialog({ open, onOpenChange }: SearchDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="p-0 gap-0 max-w-full sm:max-w-2xl max-h-[calc(100dvh-1rem)] sm:max-h-[600px] m-0 sm:m-4 flex flex-col top-2 sm:top-[50%] translate-y-0 sm:translate-y-[-50%] rounded-lg">
