...
export function WelcomeScreen({ onSearchClick }: WelcomeScreenProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100dvh-4rem)] text-center py-6 px-4">
