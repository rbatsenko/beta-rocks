...
export const ConditionsDetailDialog = memo(function ConditionsDetailDialog({
  ...
  useEffect(() => {
    ...
    if (tabSwitchStartRef.current != null) {
      ...
      logPhase("ConditionsDetailDialog", "tab-switched", {
        tab: activeTab,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh]">
        <DialogHeader>
          ...
          <DialogDescription>{t("dialog.fullAnalysis")}</DialogDescription>
        </DialogHeader>
                    ...
                    <div className="space-y-3">
                      ...
                      {data.dewPointSpread !== undefined && (
                        <div className="bg-muted/50 rounded-lg p-3">
                          ...
                          <p className="text-lg font-semibold">
                            {Math.round(data.dewPointSpread)}°C
                          </p>
                        </div>
                      )}
                    </div>
