...
/**
 * Check if a crag already exists within radius
 * Returns nearby crags within 500m
 */
async function checkNearbyCrags(
  ...
  // earth_distance uses lat/lon in radians and returns meters
  ...
  if (error) {
    ...
    // This is a simpler approximation using lat/lon differences
    const latDiff = radiusMeters / 111320; // ~111km per degree latitude
  ...
  try {
    ...
    const { data: newCrag, error: insertError } = await supabase
      ...
      .insert({
        ...
        // slug is intentionally omitted - will be auto-generated by trigger
      })
